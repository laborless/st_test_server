<template>
  ...
  <div class="Wrapper">
    <div v-if="navItem == 1">
      ...
      <img src="../assets/static-qr-code-3_400.png" style="width:300px; height:auto">
      <br>
      <a>http://193.122.103.95/udpdemo</a>
    </div>
    ...
    <div v-else>
      ...
      <br>
      <img src="../assets/static-qr-code-3_400.png" style="width:400; height:auto;">
      <br>
      <a>http://193.122.103.95/udpdemo</a><br>
